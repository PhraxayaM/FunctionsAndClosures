...
convertNumberIntoString(number: 5)
...
let marshall = Guest(name: "Marshall", age: 30)
//write the function here

func guestInfo(name: Guest) {
    let guest = Guest(name: name.name, age: name.age)
    
    print(guest.name + ",", guest.age)
    
}
guestInfo(name: eric)
guestInfo(name: marshall)
...
//write the function here
//let guestBook() = [invitedGuests]

func guestList(name: [Guest]) {
    for i in name {
        print(i)
    }
